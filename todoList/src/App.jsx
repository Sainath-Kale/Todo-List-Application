...
const App = () => {
  ...
  const [upperLimit, addupperLimit] = useState(21);
  const jsonLink = 'https://jsonplaceholder.typicode.com/users/1/todos'
  var lowerLimit = 0;
